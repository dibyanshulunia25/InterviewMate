            ...
            <div className='text-[14px] prose prose-slate dark:prose-invert max-w-none'>
                <ReactMarkdown
                    ...
                    components={{
                        ...
                        blockquote({ children }) {
                            return <blockquote className='border-l-4 border-gary-200 pl-4 italic my-4'>{children}</blockquote>;
                        },
                        h1({ children }) {
                        ...
                        h4({ children }) {
                            return <h4 className='text-base font-bold mt-6 mb-2'>{children}</h4>;
                        },
                        a({ children, href }) {
                        ...
                        img({ src, alt }) {
                            return <img className='max-w-full my-4 rounded' src={src} alt={alt} />;
                        },
        ...
        return <div className='relative my-6 rounded-lg overflow-hidden bg-gray-50 border border-gray-200'>
            <div className='flex items-center justify-between p-4 bg-gray-100 border-b border-gray-200'>
                ...
                <button onClick={copyCode} className='text-gray-500 hover:text-gray-700 focus:outline-none relative group' aria-label="Copy code">
                    ...
                    {copied && (
                        <span className="absolute -top-1 right-6 bg-black text-white text-xs rounded-md px-2 py-1 opacity-80 group-hover:opacity-100 transform">Copied!</span>
                    )}
                </button>
            </div>
