    ...
    return (
        <div className='bg-white relative'>
            <div className='container mx-auto px-10 md:px-2'>
                <div className='h-[200px] flex flex-col justify-center z-10'>
                    ...
                    <div className='flex items-center gap-5 mt-4 z-10' >
                ...
                <div className='w-[40vw] md:w-[30vw] h-[200px] flex items-center justify-center bg-white overflow-hidden absolute top-0 right-0 z-1'>
